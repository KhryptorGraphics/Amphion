...
export default function VitsSVCPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/svc/vitssvc", {
        method: "POST",
        body: formData,
      });
      ...
      toast({
        ...
        description: fullSongMode
          ? "Full song converted successfully with VitsSVC"
          : "Singing voice converted successfully with VitsSVC",
      });
    } catch (error) {
      toast({
        title: "Error",
  ...
  const handleDownload = () => {
    ...
    a.download = `vitssvc-${Date.now()}.wav`;
    ...
    <div className="container mx-auto py-6">
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2 mb-1">
          <h1 className="text-3xl font-bold tracking-tight">VitsSVC</h1>
        ...
        <p className="text-muted-foreground">
          VITS-based end-to-end singing voice conversion with variational inference and adversarial training
        </p>
      </div>

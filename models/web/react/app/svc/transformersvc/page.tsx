...
export default function TransformerSVCPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/svc/transformersvc", {
        method: "POST",
        body: formData,
      });
      ...
      toast({
        ...
        description: fullSongMode
          ? "Full song converted successfully with TransformerSVC"
          : "Singing voice converted successfully with TransformerSVC",
      });
    } catch (error) {
      toast({
        title: "Error",
  ...
  const handleDownload = () => {
    ...
    a.download = `transformersvc-${Date.now()}.wav`;
    ...
    <div className="container mx-auto py-6">
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2 mb-1">
          <h1 className="text-3xl font-bold tracking-tight">TransformerSVC</h1>
        ...
        <p className="text-muted-foreground">
          Transformer-based singing voice conversion with attention mechanisms for high-fidelity timbre transfer
        </p>
      </div>
